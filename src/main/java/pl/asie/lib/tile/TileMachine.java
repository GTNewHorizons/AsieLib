...
public class TileMachine extends TileEntityBase implements IConnectable, ISidedInventory /* RedLogic */ {
    ...
    /*
     * @Optional.Method(modid = Mods.GregTech) public boolean isGivingInformation() { return (this instanceof
     * IInformationProvider); }
     * @Optional.Method(modid = Mods.GregTech) public String[] getInfoData() { if(this instanceof IInformationProvider)
     * { IInformationProvider p = (IInformationProvider) this; ArrayList<String> data = new ArrayList<String>();
     * p.getInformation(null, ForgeDirection.UNKNOWN, data, false); return data.toArray(new String[data.size()]); } else
     * { return new String[] {}; } }
     */
}
