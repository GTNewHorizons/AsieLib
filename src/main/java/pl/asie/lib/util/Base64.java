 ...
 * <li>v2.3.6 - Fixed bug when breaking lines and the final byte of the encoded string ended in the last column; the src
 * was not properly shrunk and contained an extra (null) byte that made it into the string.</li>
 * <li>v2.3.5 - Fixed bug in {@link #encodeFromFile} where estimated src size was wrong for files of size 31, 34, and 37
 * bytes.</li>
 ...
 * #decodeToObject(java.lang.String, int, java.lang.ClassLoader) method.</li>
 ...
 * <li>v1.3.5 - Added flag to turn on and off line breaks. Fixed bug in input stream where last src being read, if not
...
public class Base64 {
    ...
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset, int options) {
        ...
        if (srcOffset < 0 || srcOffset + 3 >= source.length) {
            throw new IllegalArgumentException(
                    String.format(
                            "SourceIndex array with length %d cannot have offset of %d and still process four bytes.",
                            source.length,
                            srcOffset));
        } // end if
    ...
    public static byte[] decode(byte[] source, int off, int len, int options) throws java.io.IOException {
        ...
        if (off < 0 || off + len > source.length) {
            throw new IllegalArgumentException(
                    String.format(
                            "SourceIndex array with length %d cannot have offset of %d and process %d bytes.",
                            source.length,
                            off,
                            len));
        } // end if
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Method added by PHIL. [Thanks, PHIL. -Rob] This pads the src without closing the stream.
         * 
