...
public class MiscUtils {
    ...
    private static final int[][] handlingBT = { { 2, 3, 0, 1, 4, 5 }, { 3, 2, 1, 0, 5, 4 } };
    ...
    public static int getSideFromName(String endpoint) {
        ...
        if (endpoint.equalsIgnoreCase("front") || endpoint.equalsIgnoreCase("forward")
                || endpoint.equalsIgnoreCase("north"))
            return 2;
